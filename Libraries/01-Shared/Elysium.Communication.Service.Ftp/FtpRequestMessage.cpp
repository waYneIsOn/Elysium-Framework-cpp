...
Elysium::Communication::Service::Ftp::FtpRequestMessage::FtpRequestMessage(const Elysium::Core::Utf8String & Content)
	: Elysium::Communication::Service::Ftp::FtpMessage(Content)
{ }

Elysium::Communication::Service::Ftp::FtpRequestMessage::FtpRequestMessage(Elysium::Core::Utf8String && Content)
	: Elysium::Communication::Service::Ftp::FtpMessage(Content)
{ }
...
const Elysium::Core::Utf8StringView Elysium::Communication::Service::Ftp::FtpRequestMessage::GetCommandText() const
{
	...
	{
		return Elysium::Core::Utf8StringView(&_Content[0], IndexOfNewLine - 1);
	}
}
...
{
	const Elysium::Core::Utf8StringView CommandText = GetCommandText();
