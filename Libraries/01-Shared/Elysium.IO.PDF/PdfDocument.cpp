...
void Elysium::IO::PDF::PdfDocument::Save(const Elysium::Core::Utf8String & Target)
{
...
void Elysium::IO::PDF::PdfDocument::Save(Elysium::Core::IO::Stream & Target)
{
	...
	// pdf version
	Elysium::Core::Utf8String VersionString = u8"1.7\r\n\r\n";
